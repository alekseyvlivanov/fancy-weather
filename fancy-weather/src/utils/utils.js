...
function consoleInfo() {
  ...
  window.console.info(
    'Погодный сервис Weatherbit может давать разные цифры для разных языков, а геосервис Here для некоторых локаций всегда отдает город на английском, а страну - на запрашиваемом языке.',
  );
